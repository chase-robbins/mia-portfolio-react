      ...
      <div className="App body">
        ...
        <div className="bio-holder">
          <div className="bio-block">
            <img
              src="/images/Mia-McCarthy.png"
              loading="eager"
              sizes="(max-width: 479px) 90vw, (max-width: 991px) 45vw, 35vw"
              srcSet="/images/Mia-McCarthy-p-500.png 500w, /images/Mia-McCarthy.png 679w"
              alt=""
              className="image"
            />
          </div>
          <p className="contact-pg bdy">
            I'm a cross-disciplinary designer currently studying at{" "}
            <a href="https://iovine-young.usc.edu/">
              USC's Iovine & Young Academy
            </a>
            . I'm also a photographer for{" "}
            <a href="https://www.imgmodels.com/new-york/home">
              IMG Models Worldwide
            </a>{" "}
            and a startup founder. Enjoy!
          </p>
          <div className="contact-info">
            ...
            <div className="social-icons">
              <a
                href="https://instagram.com/miajajah"
                className="social-icon-link w-inline-block"
              >
                <img
                  src="/images/noun_instagram_2399683.png"
                  loading="lazy"
                  alt=""
                />
              </a>
              ...
              >
                <img
                  src="/images/noun_linkedin_2399666.png"
                  loading="lazy"
                  alt=""
                />
              </a>
              <a
                ...
                className="social-icon-link w-inline-block"
              >
                <img src="/images/resume.png" loading="lazy" alt="" />
              </a>
            </div>
          </div>
        </div>
